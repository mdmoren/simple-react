          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`bg-gradient-to-r ${
                ...
                newPassword.length >= 8 &&
                confirmPassword.length >= 8
                  ? "from-purple-700 to-blue-500 hover:from-purple-700 hover:to-purple-600"
                  : "bg-gray-400 cursor-not-allowed"
              } text-white font-bold py-2 px-8 rounded-md focus:outline-none shadow-black hover:shadow-lg duration-300 transition-all`}
              type="button"
